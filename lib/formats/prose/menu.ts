/**
 * Формирует меню редактора
 * Основано на prosemirror-example-setup/src/menu.ts
 */
import { wrapItem, blockTypeItem, Dropdown, joinUpItem, liftItem,
         selectParentNodeItem, undoItem, redoItem, icons, MenuItem, MenuElement,
         MenuItemSpec } from "prosemirror-menu";
